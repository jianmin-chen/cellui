...
pub fn init(allocator: Allocator) !void {
    ...
    c.glBufferData(
        c.GL_ARRAY_BUFFER,
        @sizeOf(c.GLfloat) * TEXTURE_BUFFER_SIZE,
        null,
        c.GL_DYNAMIC_DRAW
    );
    ...
    c.glBufferData(
        ...
        @sizeOf(c.GLint) * INDICES_SIZE * MAX_TEXTURES,
        null,
        c.GL_DYNAMIC_DRAW
    );
...
pub fn paint(styles: Styles) !void {
    ...
    c.glBufferSubData(
        c.GL_ARRAY_BUFFER,
        @as(c.GLint, @intCast(textures.items.len * VERTICES_SIZE)) * @sizeOf(c.GLfloat),
    ...
    c.glBufferSubData(
        c.GL_ELEMENT_ARRAY_BUFFER,
        @as(c.GLint, @intCast(textures.items.len * INDICES_SIZE)) * @sizeOf(c.GLint),
